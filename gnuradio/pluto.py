...
class pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tone_freq = tone_freq = 10e3
        self.samp_rate = samp_rate = int(2.084e6)
        ...
        # Blocks
        ##################################################
        self._tone_freq_range = Range(0, 100e3, 1e3, 10e3, 200)
        ...
        self._rx_gain_range = Range(0, 70, 1, 1, 200)
        ...
        self._lo_range = Range(450e6, 6000e6, 1e6, 1000e6, 200)
        self._lo_win = RangeWidget(self._lo_range, self.set_lo, "lo", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._lo_win)
        self._gain_range = Range(0, 5, .1, 1, 200)
        ...
        self.iio_pluto_source_0.set_frequency(int(lo))
        ...
        self.iio_pluto_sink_0.set_frequency(int(lo))
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, tone_freq, 0.1, 0, 0)
    ...
    def set_lo(self, lo):
        self.lo = lo
        self.iio_pluto_sink_0.set_frequency(int(self.lo))
        self.iio_pluto_source_0.set_frequency(int(self.lo))
